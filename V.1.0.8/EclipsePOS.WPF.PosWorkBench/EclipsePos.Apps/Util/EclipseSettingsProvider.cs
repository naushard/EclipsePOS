...
{
    public class EclipseSettingsProvider : SettingsProvider
    {
        ...
        public virtual string GetAppSettingsPath()
        {
            ...
            //System.IO.FileInfo fi = new System.IO.FileInfo(Application.Current.StartupUri.AbsolutePath);
            //return fi.DirectoryName;
            System.IO.FileInfo fi = new System.IO.FileInfo(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\" + "EclipseSoftware" + "\\" + "1.0.1" );
            if (!fi.Exists)
            {
                try
                {
                    Directory.CreateDirectory(fi.DirectoryName);// fi.Create();
                }
                catch (Exception e)
                {
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection propvals)
        {
            ...
            try
            {
               // MessageBox.Show(GetAppSettingsPath());
               // MessageBox.Show(GetAppSettingsFilename());
        ...
        public override SettingsPropertyValueCollection GetPropertyValues(SettingsContext context, SettingsPropertyCollection props)
        {
            ...
            SettingsPropertyValueCollection values = new SettingsPropertyValueCollection();    //Iterate through the settings to be retrieved 
        ...
        { 
            get {      //If we dont hold an xml document, try opening one.
