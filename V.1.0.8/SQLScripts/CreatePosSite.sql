...
go
insert into dialog_event values ( 1603, 7,  null, 0, 1, 1, 'EclipsePos.Apps.EJournal.EjTender') 
go
...
go
insert into pos_param values ( 1, 3, 4, 90, 'InsufficientUserAuthority', 'Insufficient User Authority', null) 
go
insert into pos_param values ( 1, 3, 4, 91, 'TableNumberPrompt', 'Enter Table no', null) 
go
insert into pos_param values ( 1, 3, 4, 92, 'PromptItemPrice', 'Enter Item Price', null) 
go
insert into pos_param values ( 1, 3, 4, 93, 'PriceChangeNotAllowed', 'Price change not allowed', null) 
go
insert into pos_param values ( 1, 3, 4, 94, 'SelectCustomer', 'Select customer and try again', null) 
go
insert into pos_param values ( 1, 3, 4, 95, 'InsufficientCreditLimit', 'Insufficient credit limit', null) 
go
insert into pos_param values ( 1, 3, 4, 96, 'DebtTender', 'Debt Tender', null) 
go
insert into pos_param values ( 1, 3, 4, 97, 'InvalidFunction', 'Invalid operation', null) 
go
insert into pos_param values ( 1, 3, 4, 98, 'PromptCardName', 'Enter card name and Press Enter', null) 
go
...
go
insert into pos_param values ( 2, 3, 4, 90, 'InsufficientUserAuthority', 'Insufficient User Authority', null) 
go
insert into pos_param values ( 2, 3, 4, 91, 'TableNumberPrompt', 'Enter Table no', null) 
go
insert into pos_param values ( 2, 3, 4, 92, 'PromptItemPrice', 'Enter Item Price', null) 
go
insert into pos_param values ( 2, 3, 4, 93, 'PriceChangeNotAllowed', 'Price change not allowed', null) 
go
insert into pos_param values ( 2, 3, 4, 94, 'SelectCustomer', 'Select customer and try again', null) 
go
insert into pos_param values ( 2, 3, 4, 95, 'InsufficientCreditLimit', 'Insufficient credit limit', null) 
go
insert into pos_param values ( 2, 3, 4, 96, 'DebtTender', 'Debt Tender', null) 
go
insert into pos_param values ( 2, 3, 4, 97, 'InvalidFunction', 'Invalid operation', null) 
go
insert into pos_param values ( 2, 3, 4, 98, 'PromptCardName', 'Enter card name and Press Enter', null) 
go
...
-- Panels 
 ...
 go
 insert into menu_panels values ( 2, 92, 'Miscellaneous', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 ...
 go
 insert into menu_panels values ( 2, 95, 'Main Course', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 ...
 insert into menu_panels values ( 2, 201, 'Kinds Menu', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 202, 'Sandwiches', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 203, 'Burgers', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 204, 'Pizza', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 205, 'Pasta', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 206, 'Deserts', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
 insert into menu_panels values ( 2, 207, 'Beverages', 'EclipsePos.Apps.Views.LeftMenu.LeftMenuView')
 go
...
insert into pos_key values (2, 991,	'Common Tasks',		1,   90 ,   112,	3,	20,		8,	48,		118,		90,		192,	90,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Common Tasks', 'F1')
go
	
						  				
insert into pos_key values (2, 991,	'Discounts',		1,   91,   113,	3,	140,	8,  48,		118,		91,		192,	91,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Discounts', 'F2')
go

insert into pos_key values (2, 991,	'Micellaneous',		1,   92,   114,	3,	260,	8,  48,		118,		93,		192,	92,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Miscellaneous', 'F3')
go

insert into pos_key values (2, 991,	'Tender',			1,   93,   115,	3,	380,	8,  48,		118,		94,		192,	93,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Tender', 'F4')
go

insert into pos_key values (2, 991,	'Manager',			1,   94,   116,	3,	500,	8,  48,		118,		95,		192,	94,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Manager', 'F5')
go

insert into pos_key values (2, 991,	'Main course',		1,   95,   117,	3,	620,	8,  48,		118,		96,		192,	95,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Main Course', 'F6')
go

insert into pos_key values (2, 991,	'Alt Currency',		1,   96,   118,	3,	740,	8,  48,		118,		97,		192,	96,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Alt Currency', 'F7')
go
														  				
insert into pos_key values (2, 991,	'Exit',				1,   97,   119,	3,	860,	8,  48,		118,		98,		192,	97,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Exit', 'F8')
go
...
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1003,		3,	170,		138,		48, 56,	92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Subtotal','Subtotal','F3')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1004,		3,	170,		187,		48, 56,	93,	192,	131187,	null,1, 'EclipsePos.Apps.PosEvents.Total','Total','F4')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1005,		3,	170,		236,		48, 56, 94,	192,	131188,	null,1, 'EclipsePos.Apps.PosEvents.ItemVoid','Void Item','F5')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1006,		3, 170,			285,		48, 56, 95,	192,	131189,	null,1, 'EclipsePos.Apps.PosEvents.VoidSale','Void Sale','F6')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1007,		3,  170,		334,		48, 56, 96,	192,	131190,	null,1, 'EclipsePos.Apps.PosEvents.SaveEj', 'Save Invoice','F7')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1008,		3, 170,			432,		48, 56, 97,	192,	131191,	null,1, 'EclipsePos.Apps.PosEvents.ReturnSale','Return Sale','F8')
go
insert into pos_key values (2, 90,	'Ctrl',		1,   0, 1009,		3, 170,			481,		48, 56, 98,	192,	131192,	null,1, 'EclipsePos.Apps.PosEvents.Customer','Customer','F9')
go


-- Discounts 
insert into pos_key values (2, 91,		'Ctrl',		1,   1,	1011,		3,  170,	40,			48, 56,	90,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.ItemMarkdown','Item Disc 10%','F1')
go
insert into pos_key values (2, 91,		'Ctrl',		1,   2,	1012,		3,  170,	89,			48, 56,	91,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.ItemMarkdown','Item Disc 20%','F2')
go
insert into pos_key values (2, 91,		'Ctrl',		1,   3,	1013,		3,  170,	138,		48, 56,	92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.ItemMarkdown','Item Disc 30%','F3')
go
insert into pos_key values (2, 91,		'Ctrl',		1,   4,	1014,		3,  170,	187,		48, 56,	93,	192,	131187,	null,1, 'EclipsePos.Apps.PosEvents.ItemMarkdown','Item Disc 40%','F4')
go
insert into pos_key values (2, 91,		'Ctrl',		1,   5,	1015,		3,  170,	236,		48, 56,	94,	192,	131188,	null,1, 'EclipsePos.Apps.PosEvents.ItemMarkdown','Item Disc 50%','F5')
go


-- Miscellaneous

insert into pos_key values (2, 92,		'Ctrl',		1,   0,		1021,		3,	170,	40,			48,		56,     90,		0,		131184,		null,	1,	'EclipsePos.Apps.PosEvents.PriceOverride', 'Change Price','F1')
go
insert into pos_key values (2, 92,		'Ctrl',		1,	 1,		1022,		3,  170,	89,			48,		56,		91,		50,		131185,		null,	1,	'EclipsePos.Apps.PosEvents.ExecScript', 'Calculator','F2')
go
insert into pos_key values (2, 92,		'Ctrl',		1,	 2,		1023,		3,  170,	138,		48,		56,		92,		50,		131186,		null,	1,	'EclipsePos.Apps.PosEvents.ExecScript', 'Notepad','F3')
go
insert into pos_key values (2, 92,		'Ctrl',		1,   0,		1024,		3, 170,		187,		48,		56,		93,		192,	131187,		null,	1, 'EclipsePos.Apps.PosEvents.ReceiveOnAccount','Receive on Acc','F5')
go
...
-- Manager
insert into pos_key values (2, 94,	'Ctrl',		1,   0,  1041,		3,  170,		40,		48, 56,		90,	100,	131184,		null,1,'EclipsePos.Apps.PosEvents.PaidIn', 'Paid In','F1')
go
insert into pos_key values (2, 94,	'Ctrl',		1,   0,  1042,		3,  170,		89,		48, 56,		91,	100,	131185,		null,1,'EclipsePos.Apps.PosEvents.PaidOut', 'Paid Out','F2')
go
insert into pos_key values (2, 94,	'Ctrl',		1,   0,	 1043,		3, 170,			138,	48, 56,		92,	50,		131186,		null,1, 'EclipsePos.Apps.PosEvents.TrainingMode', 'Training Mode','F3')
go
insert into pos_key values (2, 94,	'Ctrl',		1,   1,	 1044,		3,	170,		187,	48,  56,	93,	25,		131187,		null,	1,	'EclipsePos.Apps.PosEvents.TerminalReport', 'X-Report','F4')
go
insert into pos_key values (2, 94,	'Ctrl',		1,   2,	 1045,		3,	170,		236,	48,  56,    94,	0,		131188,		null,	1,	'EclipsePos.Apps.PosEvents.TerminalReport', 'Z-Report','F5')
go
...
-- Exit
insert into pos_key values (2, 97,		'Ctrl',		1,   0,	1051,		3, 170,			89,			48, 56,0,	0,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Lock','Lock','F1')
go
insert into pos_key values (2, 97,		'Ctrl',		1,   2,	 1052,		3,  170,		40,		48, 56,90,0, 131185,null,1, 'EclipsePos.Apps.PosEvents.LogOff', 'Log Off','F2')
go
insert into pos_key values (2, 97,		'Ctrl',		1,  -1,	 1053,		3,  170,		89,		48, 56,91,50, 131186,null,0, 'EclipsePos.Apps.PosEvents.Exit', 'Shutdown','F3')
go
insert into pos_key values (2, 97,		'Ctrl',		1,  -1,	 1054,		3,  170,		89,		48, 56,91,50, 131187,null,1, 'EclipsePos.Apps.PosEvents.SystemManager', 'System Manager','F4')
go



-- Main course
insert into pos_key values (2, 95,	'Ctrl',		1,   201,		1061,		3, 170,			40,		48, 56,90,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator','Kids menu','F1')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   202,		1062,		3, 170,			89,		48, 56,91,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator','Sandwiches','F2')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   203,		1063,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator','Burgers','F3')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   204,		1064,		3, 170,			138,	48, 56,92,	192,	131187,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Pizza', 'F4')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   205,		1065,		3, 170,			138,	48, 56,92,	192,	131188,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator','Pasta','F5')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   206,		1066,		3, 170,			138,	48, 56,92,	192,	131189,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Deserts', 'F6')
go
insert into pos_key values (2, 95,	'Ctrl',		1,   207,		1067,		3, 170,			138,	48, 56,92,	192,	131190,	null,1, 'EclipsePos.Apps.PosEvents.LeftMenuNavigator', 'Beverages', 'F7')
go
...
-- Alternate currency entry
insert into pos_key values (2, 96,	'Ctrl' ,		1,   1,		1071,	3,	 170,	40,   48,  56, 90,	0, 131184,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'US Dollar','F1')
go
insert into pos_key values (2, 96,	'Ctrl',			1,   2,		1072,	3,	170,	89,   48,  56, 91,	0, 131185,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'Euro','F2')
go
insert into pos_key values (2, 96,	'Ctrl',			1,   3,		1073,	3,	170,	138,  48,  56, 92,	0, 131186,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'Sterling Pound','F3')
go
insert into pos_key values (2, 96,	'Ctrl',			1,   4,		1074,	3,	170,	187,  48,  56, 93,	0, 131187,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'Aust. Dollar','F4')
go
insert into pos_key values (2, 96,	'Ctrl',			1,   5,		1075,	3,	170,	236,  48,  56, 94,	25, 131188,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'HK Dollar','F5')
go
insert into pos_key values (2, 96,	'Ctrl',			1,   6,		1076,	3,	170,	285,  48,  56, 95,	25, 131189,null,1,'EclipsePos.Apps.PosEvents.AltCurrTender', 'Yen','F6')
go
...
-- Cash tender Notes/Coins
insert into pos_key values (2, 992,	'Ctrl' ,		1,   10000,		2071,	3,	 170,	40,   48,  56, 90,	0, 131184,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '100.00','F1')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   5000,		2172,	3,	170,	89,   48,  56, 91,	0, 131185,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '50.00','F2')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   1000,		2073,	3,	170,	138,  48,  56, 92,	0, 131186,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '10.00','F3')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   500,		2074,	3,	170,	187,  48,  56, 93,	0, 131187,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '5.00','F4')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   200,		2075,	3,	170,	236,  48,  56, 94,	0, 131188,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '2.00','F5')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   100,		2076,	3,	170,	285,  48,  56, 95,	0, 131189,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '1.00','F6')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   50,		2077,	3,	170,	334,  48,  56, 96,	0, 131190,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '.50','F7')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   20,		2078,	3,	170,	383,  48,  56, 97,	0, 131191,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '.20','F8')
go

insert into pos_key values (2, 992,	'Ctrl',			1,   10,		2079,	3,	170,	432,  48,  56, 98,	0, 131192,null,1,'EclipsePos.Apps.PosEvents.MediaValue', '.10','F9')
go
...
-- Kids Manu
insert into pos_key values (2, 201,	'Ctrl',		1,   8001,		2001,		3, 170,			40,		48, 56,90,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Kids Burger','F1')
go
insert into pos_key values (2, 201,	'Ctrl',		1,   8002,		2002,		3, 170,			89,		48, 56,91,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Grilled cheese','F2')
go
insert into pos_key values (2, 201,	'Ctrl',		1,   8003,		2003,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Chicken fingers','F3')
go

-- Sandwiches  
insert into pos_key values (2, 202,	'Ctrl',		1,   2001,		2011,		3, 170,			138,	48, 56,92,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Chx Fillet sandwiches', 'F1')
go
insert into pos_key values (2, 202,	'Ctrl',		1,   2002,		2012,		3, 170,			138,	48, 56,92,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Tuna melt sandwiches','F2')
go
insert into pos_key values (2, 202,	'Ctrl',		1,   2003,		2013,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Stk cheese sandwitches', 'F3')
go
														  				


-- Burgers
insert into pos_key values (2, 203,	'Ctrl',		1,   3001,		2021,		3, 170,			138,	48, 56,92,	192,	131184,	'\\Pictures\burger2', 1, 'EclipsePos.Apps.PosEvents.Plu', 'Supreme chx burger', 'F1')
go
  
insert into pos_key values (2, 203,	'Ctrl',		1,   3002,		2022,		3, 170,			138,	48, 56,92,	192,	131185,	'\\Pictures\\Food - Burger 1.bmp', 1, 'EclipsePos.Apps.PosEvents.Plu','Cheese burger','F2')
go
   
insert into pos_key values (2, 203,	'Ctrl',		1,   3003,		2023,		3, 170,			138,	48, 56,92,	192,	131186,	null, 1, 'EclipsePos.Apps.PosEvents.Plu', 'Vegi burger', 'F3')
go
...
-- Pizza  
insert into pos_key values (2, 204,	'Ctrl',		1,   4001,		2031,		3, 170,			138,	48, 56,92,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Slice of todays pizza', 'F1')
go
  
insert into pos_key values (2, 204,	'Ctrl',		1,   4002,		2032,		3, 170,			138,	48, 56,92,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Pepperoni lovers','F2')
go
   
insert into pos_key values (2, 204,	'Ctrl',		1,   4003,		2033,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Hawaian deluxe', 'F3')
go
...
-- Pasta  
insert into pos_key values (2, 205,	'Ctrl',		1,   5001,		2041,		3, 170,			138,	48, 56,92,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Pasta Primavera', 'F1')
go
  
insert into pos_key values (2, 205,	'Ctrl',		1,   5002,		2042,		3, 170,			138,	48, 56,92,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Marinara Lasagna','F2')
go
   
		

-- Deserts  
insert into pos_key values (2, 206,	'Ctrl',		1,   6001,		2051,		3, 170,			138,	48, 56,92,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Chocolate cake', 'F1')
go
  
insert into pos_key values (2, 206,	'Ctrl',		1,   6002,		2052,		3, 170,			138,	48, 56,92,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Starwbery short cake','F2')
go
   
insert into pos_key values (2, 206,	'Ctrl',		1,   6003,		2053,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Sandae', 'F3')
go
...
-- Beverages  
insert into pos_key values (2, 207,	'Ctrl',		1,   7001,		2061,		3, 170,			138,	48, 56,92,	192,	131184,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Coca cola', 'F1')
go
  
insert into pos_key values (2, 207,	'Ctrl',		1,   7002,		2062,		3, 170,			138,	48, 56,92,	192,	131185,	null,1, 'EclipsePos.Apps.PosEvents.Plu','Srite','F2')
go
   
insert into pos_key values (2, 207,	'Ctrl',		1,   7003,		2063,		3, 170,			138,	48, 56,92,	192,	131186,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Sunkist', 'F3')
go

insert into pos_key values (2, 207,	'Ctrl',		1,   7004,		2064,		3, 170,			138,	48, 56,92,	192,	131187,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Bottle water', 'F4')
go

insert into pos_key values (2, 207,	'Ctrl',		1,   7005,		2065,		3, 170,			138,	48, 56,92,	192,	131188,	null,1, 'EclipsePos.Apps.PosEvents.Plu', 'Ice tea', 'F5')
go
...
-- Kids menu
INSERT INTO ITEM VALUES('12', '8001' ,'Kids burger' , 2.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '8001')
go

INSERT INTO ITEM VALUES('12', '8002' ,'Grilled cheese' ,2.70,  null, null, 20, '1', null, null, 1, 0,  null, null, '8002')
go

INSERT INTO ITEM VALUES('12', '8003' ,'Chx Fingers' ,2.0,  null, null, 20, '1', null, null, 1, 0, null, null,  '8003')
go



-- Sandwiches
INSERT INTO ITEM VALUES('12', '2001' ,'Chx fillet sandwiches' , 1.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '2001')
go

INSERT INTO ITEM VALUES('12', '2002' ,'Tuna melt sandwiches' ,1.70,  null, null, 20, '1', null, null, 1, 0,  null, null, '2002')
go

INSERT INTO ITEM VALUES('12', '2003' ,'Stk cheese sandwiches' ,1.0,  null, null, 20, '1', null, null, 1, 0, null, null,  '2003')
go


-- Burgers
INSERT INTO ITEM VALUES('12', '3001' ,'Supreme chx burger' , 2.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '3001')
go

INSERT INTO ITEM VALUES('12', '3002' ,'Cheese burger' ,2.70,  null, null, 20, '1', null, null, 1, 0,  null, null, '3002')
go

INSERT INTO ITEM VALUES('12', '3003' ,'Vegi burger' ,2.0,  null, null, 20, '1', null, null, 1, 0, null, null,  '3003')
go


-- Pizza

INSERT INTO ITEM VALUES('12', '4001' ,'Slice of todays pizza' , 12.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '4001')
go

INSERT INTO ITEM VALUES('12', '4002' ,'Pepperoni lovers' ,12.70,  null, null, 20, '1', null, null, 1, 0,  null, null, '4002')
go

INSERT INTO ITEM VALUES('12', '4003' ,'Hawaian deluxe' ,14.0,  null, null, 20, '1', null, null, 1, 0,  null, null, '4003')
go


-- Pasta
INSERT INTO ITEM VALUES('12', '5001' ,'Pasta primavera' , 4.50,  null, null,20, '1', null, null, 1, 0,  null, null, '5001')
go

INSERT INTO ITEM VALUES('12', '5002' ,'Marinara Lasagna' ,4.20,  null, null, 20, '1', null, null, 1, 0,  null, null, '5002')
go



-- Deserts
INSERT INTO ITEM VALUES('12', '6001' ,'Chocolate cake' , 1.90,  null, null, 20, '1', null, null, 1, 0,  null, null, '6001')
go

INSERT INTO ITEM VALUES('12', '6002' ,'Strawbery short cake' , 1.80,  null, null, 20, '1', null, null, 1, 0,  null, null, '6002')
go

INSERT INTO ITEM VALUES('12', '6003' ,'Sandae' , 1.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '6003')
go



-- Beverages
INSERT INTO ITEM VALUES('12', '7001' ,'Coca cola' , 0.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '7001')
go

INSERT INTO ITEM VALUES('12', '7002' ,'Sprite' ,0.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '7002')
go

INSERT INTO ITEM VALUES('12', '7003' ,'Sunkist' , 0.30,  null, null, 20, '1', null, null, 1, 0,  null, null, '7003')
go

INSERT INTO ITEM VALUES('12', '7004' ,'Bottle water' , 0.30,  null, null, 20, '1', null, null, 1, 0,  null, null, '7004')
go

INSERT INTO ITEM VALUES('12', '7005' ,'Iced tea' , 0.40,  null, null, 20, '1', null, null, 1, 0,  null, null, '7005')
go
...
insert into promotion values ( '12', 1, 1,   1, 0, 0, 0, 0,    10.00,  0, 0, 0, 0,   0,	 '2001-01-01', '2099-01-01', 'Item markdown ',	'EclipsePos.Apps.Operators.ItemDiscount' )
go

insert into promotion values ( '12', 2, 1,   1, 0, 0, 0, 0,    20.00,  0, 0, 0, 0,   0,	 '2001-01-01', '2099-01-01', 'Item markdown ',	'EclipsePos.Apps.Operators.ItemDiscount' )
go

insert into promotion values ( '12', 3, 1,   1, 0, 0, 0, 0,    30.00,  0, 0, 0, 0,   0,	 '2001-01-01', '2099-01-01', 'Item markdown ',	'EclipsePos.Apps.Operators.ItemDiscount' )
go

insert into promotion values ( '12', 4, 1,   1, 0, 0, 0, 0,    40.00,  0, 0, 0, 0,   0,	 '2001-01-01', '2099-01-01', 'Item markdown ',	'EclipsePos.Apps.Operators.ItemDiscount' )
go

insert into promotion values ( '12', 5, 1,   1, 0, 0, 0, 0,    50.00,  0, 0, 0, 0,   0,	 '2001-01-01', '2099-01-01', 'Item markdown ',	'EclipsePos.Apps.Operators.ItemDiscount' )
go
