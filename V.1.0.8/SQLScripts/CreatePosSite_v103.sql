...
go
 ...
 go
 insert into menu_panels values ( 1, 995, 'Item Search Keys', 'EclipsePos.Apps.Views.BottomMenu.BottomMenuView')
 go
 insert into menu_panels values ( 1, 996, 'Item details keys', 'EclipsePos.Apps.Views.BottomMenu.BottomMenuView')
 go


-- Menus for Retail
insert into menu_config values ( 1, 1, 'Discount',		91,  0,  991)
go
insert into menu_config values ( 1, 2, 'Tender',		93, 96,  991)
go
insert into menu_config values ( 1, 3, 'Manager',		94,  0,  991)
go
insert into menu_config values ( 1, 4, 'Miscellaneous',	97,  0,  991)
go
insert into menu_config values ( 1, 5, 'Exit',			93,  0, 991)
go
...
insert into pos_key values (1, 991,	'Discounts',		1,   1,   113,	3,	140,	8,  48,		118,		91,		192,	91,	null,1, 'EclipsePos.Apps.PosEvents.MenuNavigator', 'Discounts', 'F2')
go
insert into pos_key values (1, 991,	'Tender',			1,   2,   114,	3,	380,	8,  48,		118,		94,		192,	93,	null,1, 'EclipsePos.Apps.PosEvents.MenuNavigator', 'Tender', 'F4')
go
insert into pos_key values (1, 991,	'Manager',			1,   3,   115,	3,	500,	8,  48,		118,		95,		192,	94,	null,1, 'EclipsePos.Apps.PosEvents.MenuNavigator', 'Manager', 'F5')
go
insert into pos_key values (1, 991,	'Miscellaneous',	1,   4,   116,	3,	260,	8,  48,		118,		93,		192,	92,	null,1, 'EclipsePos.Apps.PosEvents.MenuNavigator', 'Miscellaneous', 'F3')
go
insert into pos_key values (1, 991,	'Exit',				1,   5,   117,	3,	860,	8,  48,		118,		98,		192,	97,	null,1, 'EclipsePos.Apps.PosEvents.MenuNavigator', 'Exit', 'F9')
go
...
-- Item Search Keys
insert into pos_key values (1, 995,	'Find',			1,   0,		1061,		3, 170,			40,		48, 56,90,	192,	4131142,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Find ','F1')
go
insert into pos_key values (1, 995,	'Select',		1,   5,		1062,		3, 170,			89,		48, 56,91,	192,	4131143,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Select','F2')
go
insert into pos_key values (1, 995,	'Details',		1,   8,		1063,		3, 170,			138,	48, 56,92,	192,	4131145,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Details','F3')
go
insert into pos_key values (1, 995,	'Clear',		1,   7,		1064,		3, 170,			138,	48, 56,92,	192,	4131146,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Clear','F4')
go
insert into pos_key values (1, 995,	'Up',		1,   3,		1065,		3, 170,			138,	48, 56,92,	192,	4131147,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Pg up','F4')
go
insert into pos_key values (1, 995,	'Down',		1,   4,		1066,		3, 170,			138,	48, 56,92,	192,	4131148,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Pg dn','F4')
go
  													  		  

-- Item Search Keys
insert into pos_key values (1, 996,	'Select',	1,   5,		1065,		3, 170,			40,		48, 56,90,	192,	4131152,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Find ','F1')
go
insert into pos_key values (1, 996,	'Cancel',	1,   9,		1066,		3, 170,			89,		48, 56,91,	192,	4131153,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Select','F2')
go
insert into pos_key values (1, 996,	'Previous',	1,   4,		1067,		3, 170,			138,	48, 56,92,	192,	4131155,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Details','F3')
go
insert into pos_key values (1, 996,	'Next',		1,   3,		1068,		3, 170,			138,	48, 56,92,	192,	4131156,	null,1, 'EclipsePos.Apps.PosEvents.LookupEvent','Clear','F4')
go
...
go
insert into pos_param values ( 1, 1, 6, 6, 'CashMenu', '92', null) 
go
insert into pos_param values ( 1, 1, 6, 7, 'CreditMenu', '91', null) 
go
...
go
insert into pos_param values ( 1, 1, 6, 17, 'HomeMenuID', '99', null) 
go
...
go
insert into pos_param values ( 2, 1, 6, 6, 'CashMediaMenuNo', '992', null) 
go
...
INSERT INTO ITEM VALUES('12', '57' ,'Café Latte' , 4.00,  null, '1', 20, '1', null, null, 1, 0,  null, null, null, 1.0)
go
...
go
INSERT INTO ITEM VALUES('12', '1204' ,'Crème Caramel' ,7.88,  null, '9', 20, '1', null, null, 1, 0,  null, null, null, 1.0)
go
